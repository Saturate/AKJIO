...
<dl>
  ...
  <dt>Related</dt>
  <dd><a href="/bankgpt-ctf-writeup">BankGPT writeup</a> - same technique</dd>
</dl>
...
Same [elaborate technique from BankGPT](/bankgpt-ctf-writeup): frame extraction as onboarding clarification.
...
See the [BankGPT writeup](/bankgpt-ctf-writeup) for detailed analysis of why this approach is broken and proper mitigation strategies.
