...
This challenge demonstrates why embedding secrets in system prompts is broken. While it seems obvious that hardcoding API keys in prompts is a terrible idea, real-world implementations continue to surprise us with similar mistakes.

Creating realistic prompt injection challenges is genuinely difficult; I've tried it myself. This one landed on the easier side: two prompts and we're done. The assistant leaked its entire system prompt without any defensive behavior.
